...
with col1:
    # R.png must sit beside this script
    st.markdown(
...
T3_FLIGHTS = [
    # … your full list of T3 flights …
]
LGW_FLIGHTS = [
    # … your full list of LGW flights …
]
...
text_input    = st.text_area("", placeholder="Paste content from Ops Dashboard here", height=200)
