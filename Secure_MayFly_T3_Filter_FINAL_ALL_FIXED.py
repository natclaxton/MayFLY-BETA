...
st.set_page_config(
    page_title="British Airways MayFly Generator",
    page_icon="✈️",
    layout="wide"
)

# Inject custom CSS for white background, light-blue text, and Mylus Modern font
st.markdown("""
<style>
  ...
  /* Sidebar widgets and main area text */
  .stTextInput, .stDateInput, .stSelectbox, .stRadio, .stTextArea, label, .stMarkdown {
    color: #69c9ff !important;
    font-family: "Mylus Modern", sans-serif !important;
  }
  /* Buttons and accents */
  .stButton>button {
...
LIGHT_RED = (255,  72,  54)   # Warm red (#f64936)
...
selected_date = st.date_input(
    "Select MayFly Date", datetime.today(), format="DD/MM/YYYY"
)
