        ...
        for _, row in data.iterrows():
            for i, key in enumerate(
                ...
                if key == "Load Factor":
                    ...
                    if load > 100:
                        # You can adjust: highlight >100% in red
    ...
    while i < len(lines):
        if lines[i].startswith("BA"):
            try:
                ...
                std_match  = re.search(r"STD: \d{2} \w+ - (\d{2}:\d{2})z",
                                       lines[i+4])
                ...
                if std_match and load_match:
                    ...
                    etd_z1 = (etd_utc + timedelta(hours=1)).strftime("%H:%M")
                    conf  = (etd_utc + timedelta(minutes=25)).strftime("%H:%M")
